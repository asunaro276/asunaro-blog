...
export class Article {
  ...
  private _tableOfContents: Heading[] = []
  ...
  private async parseBody() {
    ...
    this._htmlBody = $('body').html() as string
  }
  ...
  private parseHeadings() {
    ...
    const toc: Heading[] = headings.map((data: any) => ({
      ...
      htmlTag: data.name,
      attribsId: data.attribs.id,
    }))
    this._tableOfContents = toc
  }
